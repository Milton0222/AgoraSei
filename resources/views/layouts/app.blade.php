            ...
            <ul class="sidebar-menu">
                <li class="sidebar-item">
                    <a href="{{route('dashboard')}}" class="sidebar-link active">
                        <i class="fa-solid fa-chart-line text-blue-500"></i>Visão Geral
                    </a>
                </li>
                <!-- <li class="sidebar-item">
...
<script>
    ...
    function salvarFormulario() {
            const formS=document.getElementById('form-instituicao');
           const descricao= document.getElementById('descricao').value;
           const tipo= document.getElementById('tipo').value;
           const modalidade= document.getElementById('modalidade_estudo').value;
           const localizacao= document.getElementById('localizacao').value;
           const telefone= document.getElementById('linha_atendimento').value;
           const data= document.getElementById('inicio_funcao').value;
           const decreto= document.getElementById('reconhecido').value;

           if(!descricao || !tipo || !modalidade || !localizacao || !telefone || !data || !decreto ){
                 
                    alert('Prencher campos obrigatorios(*)');
               return;
           }
            formS.submit();
